...
-- filtrando colunas
filmes = FOREACH joined GENERATE (int) data_avg::filmeId AS filmeid, (chararray) item::filmeTitulo AS filmetitulo, (float) data_avg::classificacao AS classificacao;
...
-- salvando os dados no hbase

STORE resultado INTO 'hbase://pig_hbase' 
USING org.apache.pig.backend.hadoop.hbase.HBaseStorage('filmeid:filmeid, filmetitulo:filmetitulo, classificacao:classificacao');
